...
# remove that as well
def overlap(top_image, bottom_image, left, leftonetran, left_add):
    global left_cached
    global right_cached
...
def stitch_pics(l, m, r, atran, lptran, rptran, leftonetran, right_add, left_add):
    ...
    return overlap(overlap(lt, mt, True), rt, False, leftonetran, left_add)
